...
return [
    ...
    'edit' => [
        ...
        'streamkey' => '串流码',
        'openhls' => '启用hls直播',
        'hlsurl' => 'm3u8/http-flv地址',
        'rtmpfirst' => '优先使用rtmp播放',
        'cover_choose' => '选择封面',
        'roomkey' => '房间密钥(自动生成)',
        'reroomkey' => '重新生产房间密钥',
    ...
    'room' => [
        'page_title' => '播放页',
        'change_player_tips' => '本房间可以点击房间简介切换播放器(flashplayer和html5 player)哦。（手机除外）',
        'can_not_found_room' => '房间无效。',
        'changeplayer' => '更换播放器',
        'cooperate_room_list' => '联播房间',
        'tips_title' => '提示（点击关闭）',
        'online_tips' => '在线：',
        'chat_send' => '发送',
        ...
        'not_room_owner' => '你不是房间主人，不允许访问该页面。',
    ],
    'oauth' => [
        'recall' => [
    ...
    'form' => [
        'roomedit' => [
            ...
            'must_open_one_least_type' => '至少选择一种直播方式(rtmp或者hls)！',
            'must_has_rtmlurl_key_when_openrtmp' => '启用rtmp串流必须填写rtmp地址和串流码！',
            'must_has_hlsurl_when_openhls' => '启用hls直播必须填写m3u8/http-flv文件地址。',
            'hlsurl_uncorrect' => 'm3u8/http-flv地址不正确，必须为“http://”或者“https://”开头，“.m3u8”或者“.flv”结尾。',
